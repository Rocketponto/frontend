...
function RemoverRocketcoins({ onUpdate }: RemoverRocketcoinsProps) {
   ...
   const handleSubmit = async (e: React.FormEvent) => {
      ...
      if (saldoUsuario !== null && valorNum > saldoUsuario) {
         setErro(`Valor excede o saldo disponível (RC$ ${saldoUsuario.toFixed(2)})`)
         return
      }
      ...
      try {
         ...
         if (response.success) {
            ...
            alert(`RC$ ${valorNum.toFixed(2)} removido com sucesso de ${usuarioSelecionado.name}!`)
         } else {
   ...
   const valorExcedeSaldo = saldoUsuario !== null && Number(valor) > saldoUsuario
      ...
      <div className="space-y-6">
         ...
         <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
               ...
               <p className="text-gray-400">
                  Debitar moedas de usuários do sistema
               </p>
            </div>
         </div>
                  ...
                  {carregando ? (
                     ...
                     usuariosFiltrados.map((usuario) => (
                        <button
                           ...
                           className={`w-full p-3 rounded-lg text-left transition-all border ${usuarioSelecionado?.id === usuario.id
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
               ...
               <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                     ...
                     <div className={`p-3 rounded-lg border ${usuarioSelecionado
                  ...
                  <div>
                     ...
                     <input
                        ...
                        placeholder="0.00"
                        className={`w-full rounded-lg px-3 py-2 border focus:outline-none ${valorExcedeSaldo
         ...
         {usuarioSelecionado && valor && titulo && !valorExcedeSaldo && (
            <div className="bg-red-600/10 border border-red-500/30 rounded-lg p-4">
               <h4 className="text-red-400 font-medium mb-2">Preview da Transação</h4>
               ...
               {saldoUsuario !== null && (
                  <div className="text-gray-400 text-sm mt-1">
                     Saldo após transação: RC$ {(saldoUsuario - Number(valor || 0)).toFixed(2)}
                  </div>
               )}
            </div>
         )}
            ...
            <div className="flex items-start space-x-3">
               ...
               <div>
                  ...
                  <p className="text-gray-300 text-sm">
                     Esta ação remove rocketcoins permanentemente do usuário. Certifique-se de que a remoção é necessária e justificada.
                  </p>
               </div>
            </div>
         </div>
