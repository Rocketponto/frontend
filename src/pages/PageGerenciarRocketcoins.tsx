      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-blue-600/10 border border-blue-500/30 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-blue-400 text-sm font-medium">Total de Usuários</div>
        ...
        <div className="bg-green-600/10 border border-green-500/30 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-green-400 text-sm font-medium">Total Distribuído</div>
              <div className="text-2xl font-bold text-white">
                RC$ {carregando ? '...' : estatisticas.totalDistribuido.toFixed(2)}
              </div>
            </div>
        ...
        <div className="bg-yellow-600/10 border border-yellow-500/30 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-yellow-400 text-sm font-medium">Solicitações Pendentes</div>
              <div className="text-2xl font-bold text-white">
        ...
        <div className="bg-purple-600/10 border border-purple-500/30 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-purple-400 text-sm font-medium">Transações Hoje</div>
              <div className="text-2xl font-bold text-white">
